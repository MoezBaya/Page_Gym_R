  ...
  return <section id='pricing-plan'>
	<div className="container">
		<div className="pricing__top">
			<h2 className="section__title">Gym <span className="hightlights">Pricing </span>Plan</h2>
			<p>Lorem ipsum dolor sit amet consectetur adipisicing<br/> elit. Ipsa quae aperiam, ipsum nihil eos quam?</p>
		</div>
			...
			<div className="pricing__item" data-aos='fade-up' data-aos-duration='1500'>
				...
				<div className="services">
					<ul>
						...
						<li><span><i className="ri-checkbox-blank-circle-fill"></i></span>Customers support</li>
